...
const fetchDashboardData = async () => {
        try {
          ...
          const response = await ApiService.getBuilderList(params); // Fetch dashboard data
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Builder List" pageTitle="Builder" />
                    <Row>
                        <Col lg={12}>
                            <Card id="agentList">
                                <Card.Header >
                                    <Row className="align-items-center gy-3">
                                        ...
                                        <Col xs={6} className="col-md-auto text-end">
                                            <div className="d-flex flex-wrap align-items-start gap-2">
                                                <Button className="btn btn-subtle-danger d-none" id="remove-actions"><i className="ri-delete-bin-2-line"></i></Button>
                                                <Button variant="secondary" onClick={handleShowAgentmodal}><i className="bi bi-person-plus align-baseline me-1"></i> Add Agent</Button>
                                            </div>
                                        </Col>
                                    </Row>
                                </Card.Header>
            ...
            <AddAgentModal
                ...
                editagent={editagent} 
                fetchDashboardData={fetchDashboardData}         // Pass flag for edit mode
            />
