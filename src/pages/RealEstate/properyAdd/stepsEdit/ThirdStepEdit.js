...
import { collections_Select_data, foundation_Select_data, garage_location_Select_data, garage_type_Select_data, lot_features_Select_data, special_features_Select_data } from '../constant';
...
const ThirdStep = ({ setFieldValue, errors, touched, values }) => {
    return (
      ...
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <InputLabel id="optional_foundation-label">Optional Foundation</InputLabel>
          <Select
            labelId="optional_foundation-label"
            name="optional_foundation"
            label="Optional Foundation"
            value={values.optional_foundation}
            onChange={(e) => setFieldValue('optional_foundation', e.target.value)}
          >
            {foundation_Select_data.map((ele, index) => (
              <MenuItem value={ele.value} key={index}>{ele.label}</MenuItem>
            ))}
      ...
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <InputLabel id="different_foundation-label">Different Foundation</InputLabel>
          <Select
            labelId="different_foundation-label"
            name="different_foundation"
            label="Standard Foundation"
            value={values.different_foundation}
            onChange={(e) => setFieldValue('different_foundation', e.target.value)}
          >
            {foundation_Select_data.map((ele, index) => (
              <MenuItem value={ele.value} key={index}>{ele.label}</MenuItem>
            ))}
      ...
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <TextField
            name="exterior_standard_type"
            label="Exterior Wall Standard Type"
            variant="outlined"
            value={values.exterior_standard_type}
            onChange={(e) => setFieldValue('exterior_standard_type', e.target.value)}
          />
        </FormControl>
      </Grid>
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <TextField
            name="exterior_optional_type"
            label="Exterior Wall Optional Type"
            variant="outlined"
            value={values.exterior_optional_type}
            onChange={(e) => setFieldValue('exterior_optional_type', e.target.value)}
          />
        </FormControl>
      </Grid>
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <TextField
            name="roof_primary_pitch"
            label="Roof Primary Pitch"
            variant="outlined"
            value={values.roof_primary_pitch}
            onChange={(e) => setFieldValue('roof_primary_pitch', e.target.value)}
          />
        </FormControl>
      </Grid>
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <TextField
            name="roof_secondary_pitch"
            label="Roof Secondary Pitch"
            variant="outlined"
            value={values.roof_secondary_pitch}
            onChange={(e) => setFieldValue('roof_secondary_pitch', e.target.value)}
          />
        </FormControl>
      </Grid>
      <Grid item xs={12} sm={6}>
        <FormControl fullWidth margin="normal">
          <TextField
            name="roof_framing_type"
            label="Roof Framing Type"
            variant="outlined"
            value={values.roof_framing_type}
            onChange={(e) => setFieldValue('roof_framing_type', e.target.value)}
          />
        </FormControl>
      </Grid>
        </>
